...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Sofia+Sans:ital,wght@0,300;0,400;0,500;0,600;0,800;0,900;1,300;1,400;1,500;1,600;1,800;1,900&display=swap"
        rel="stylesheet">
...
<body>
        ...
        <div class="container-fluid nav">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" role="search">
                    <div>
                        <input class="form-control me-2 searchh" type="search"
                            placeholder="Търсете по модел или актуален номер" aria-label="Search">
                    </div>
                </form>
                <div class="nomer">
                    Tелефон за поръчки и сервиз
                    <span class="nomerflex">
                        <img src="assets/img/logophone.png" class="imgphone">
    ...
    <div class="offcanvas offcanvas-top bodyofcanvas" tabindex="-1" id="ProductsNavOffcanvas"
        aria-labelledby="ProductsNavOffcanvasLabel">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary dis">
        <div class="container-fluid nav">
            ...
            <button class="mobilenav-btn " type="button" data-bs-toggle="offcanvas"
                data-bs-target="#ProductsNavMobilleOffcanvas" aria-controls="ProductsNavMobilleOffcanvas">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#ffc803" class="bi bi-justify"
                    viewBox="0 0 16 16">
    ...
    <div class="offcanvas offcanvas-top bodyofcanvas" tabindex="-1" id="ProductsNavMobilleOffcanvas"
        ...
        <div class="offcanvas-body ">
            <div class="btn-vijpowechemobillenav">
                <button class="btn btn-vshichkiproducti" type="button" data-bs-toggle="offcanvas"
                    data-bs-target="#offcanvasTopmoblle" aria-controls="offcanvasTopmoblle">Всички
                    продукти</button>
            </div>
            <div>
            ...
            <div class="footer-opciii1">
                <div class="ps-3 mobilnum-footer">
                    <span class="d-flex flex-column" style="font-size:14px; color: black; font-weight: 700;">
                        ...
                        <a href="tel:+359898573708" class="phone-product7"><img src="assets/img/logophone.png"
                                class="k">
                            +359 899 065 105</a>
                    </span>
                </div>
